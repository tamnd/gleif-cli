...
// HTTP behaviour is covered in gleif_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "gleif://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("gleif", "about")
	if err != nil || got.String() != "gleif://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want gleif://page/about", got.String(), err)
	}
}
