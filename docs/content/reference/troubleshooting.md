...
Most of these come down to network reality or how gleif serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gleif rate-limits like any public site. gleif already paces
...
Where a surface is gated, gleif reads a cookie or token you supply
...
`gleif`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gleif actually did
